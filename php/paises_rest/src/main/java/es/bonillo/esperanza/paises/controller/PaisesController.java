...
public class PaisesController {
	...
	public ResponseEntity<?> getPais(@PathVariable String id) {
		...
		try {
			Pais pais = service.getPais(id); // FIXME el metodo del servicio esta sin terminar.
			if(pais != null) {
	...
	public ResponseEntity<?> save(@RequestBody Pais pais){
		// TODO implementar POST, implementando en el servicio el metodo save e invocandolo desde aqui.
		return null;
	}
	
	@PutMapping("{id}") 
	public ResponseEntity<?> update(@RequestBody Pais pais){
		// TODO implementar PUT, llamando al metodo existente del servicio.
		return null;
	}
	...
	public ResponseEntity<?> delete(@PathVariable String id){
		// TODO implementar DELETE, llamando al metodo existente del servicio.
		return null;
	}
}
